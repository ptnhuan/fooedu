...
namespace Slideshow\Controllers\Admin;

use Illuminate\Http\Request;
use Slideshow\Controllers\Admin\MyController;
use URL;
use Route,
    Redirect;

use Slideshow\Models\Slideshows;
use Slideshow\Models\SlideshowsCategories;
/**
 * Validators
 */
use Slideshow\Validators\SlideshowAdminValidator;
