...
class SlideshowServiceProvider extends ServiceProvider {
    ...
    public function boot(Request $request) {
        ...
        $this->publishes([
            __DIR__ . '/public' => public_path('slideshow'),
                ], 'public');
    ...
    public function register() {
         ...
         * Load controllers
         */
        $this->app->make('Slideshow\Controllers\Admin\SlideshowAdminController');
        $this->app->make('Slideshow\Controllers\Front\SlideshowFrontController');
        /**
         * Load Views
         */
        $this->loadViewsFrom(__DIR__ . '/views', 'slideshow');
