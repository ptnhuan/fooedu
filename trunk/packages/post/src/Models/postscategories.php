...
class PostsCategories extends Model {
    ...
    public function update_post($input, $post_id = NULL) {
        ...
        if (!empty($post)) {
            ...
            $post->post_category_desription = $input['post_category_desription'];
            $post->post_category_img = $input['post_category_img'];
            $post->save();
    ...
    public function add_post($input) {
        ...
        $post = self::create([
                    ...
                    'post_category_desription' => $input['post_category_desription'],
                    'post_category_img' => $input['post_category_img'],
        ]);
        return $post;
    }
