...
Route::post('/send', [
    'as' => 'send',
    'uses' => 'Contact\Controllers\Front\ContactFrontController@add'
    ]);

/*FUNCTION EDIT*/
Route::get('contact/edit', [
    'as' => 'contact.edit',
    'uses' => 'Contact\Controllers\Front\ContactFrontController@edit'
    ]);

/*FUNCTION UPDATE*/
Route::post('contact/edit', [
    'as' => 'contact.post',
    'uses' => 'Contact\Controllers\Front\ContactFrontController@post'
    ]);

/*FUNCTION DELETE*/
Route::get('contact/delete', [
    'as' => 'contact.delete',
    'uses' => 'Contact\Controllers\Front\ContactFrontController@delete'
    ]);
 ...
 * ADMINISTRATOR
 */
Route::group(['middleware' => ['web'],'namespace'=>'Contact\Controllers\Admin'], function () {
