...
<div class="row margin-bottom-12">
    <div class="col-md-12">
        <a href="{!! URL::route('admin_contact_category.edit') !!}" class="btn btn-info pull-right">
            <i class="fa fa-plus"></i>{{trans('contact::contact.button_add_category')}}
        </a>
    </div>
</div>
...
<table class="table table-hover">
    <thead>
        <tr>
            <td style='width:5%'>
                {{ trans('contact::contact.field_contact_status') }}
            </td>


            <th style='width:50%'>
                {{ trans('contact::contact.field_contact_email') }}
            </th>

            <th style='width:20%'>
                {{ trans('contact::contact.field_contact_operations') }}
            </th>
        </tr>
    </thead>
    <tbody>
