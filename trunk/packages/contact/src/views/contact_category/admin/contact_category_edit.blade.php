            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        {!! !empty($contact->contacts_category_id) ? '<i class="fa fa-pencil"></i>'.trans('contact::contact.form_edit') : '<i class="fa fa-users"></i>'.trans('contact::contact.form_add') !!}
                    </h3>
                </div>
                <!-- ERRORS NAME  -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <h4>{!! trans('contact::contact.form_genaral') !!}</h4>
